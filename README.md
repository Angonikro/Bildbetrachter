...
![Sprachassistent](Bildbetrachter.png)
...
2. **Bildbetrachter herunterladen**
   - Lade die Datei `Bildbetrachter_v0.1.11_GITHUB_RELEASE.zip` aus dem GitHub-Release herunter.
...
`Bildbetrachter_Anleitung_v0.1.11.pdf`
